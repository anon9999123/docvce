...
if [[ $SLURM_LOCALID == 0 ]]; then
  ...
  pip install -U diffusers accelerate lpips taming-transformers

  # apt update
  # apt install -y libtesseract5 tesseract-ocr tesseract-ocr-eng tesseract-ocr-osd poppler-utils
