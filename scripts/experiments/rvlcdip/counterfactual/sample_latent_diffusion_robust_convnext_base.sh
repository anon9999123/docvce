...
PYTHONPATH=$PYTHONPATH TASK=document_classification DATASET=rvlcdip python ./external/atria/src/atria/core/task_runners/atria_model_evaluator.py \
    ...
    torch_model_builder@task_module.torch_model_builder.classifier=local \
    task_module.torch_model_builder.classifier.model_name=docvce.models.task_modules.convnext.convnext_base \
    ...
    classifier_output_name=robust_convnext \
    $@
