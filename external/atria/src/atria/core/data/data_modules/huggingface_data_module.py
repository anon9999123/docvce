...
class HuggingfaceDataModule(AtriaDataModule):
    def __init__(
        ...
        super().__init__(
            ...
            data_labels_override=data_labels_override,
            combine_train_and_test_for_test=combine_train_and_test_for_test,
        )
        self._token = token
        self._builder = None
    ...
    def _get_download_config(self) -> DownloadConfig:
        ...
        # download_config.cache_dir = self._dataset_cacher.cache_dir
